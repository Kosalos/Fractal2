...
// 20-----------------------------------------------------------
float DE_FULL_TETRA(float3 pos) {
	int i;
	...
	return (length(pos) - 2) * pow(Q1, -float(i));
}
...
float DE_QUATJULIA2(float3 pos) {
